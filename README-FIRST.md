# SIMS Manager v6.1.9 Repository Baseline
...
このZIP内の `SIMS-Manager/` を既存SIMS Managerリポジトリへ反映してください。既存の履歴ファイルは保持し、同名の現行正本ファイルはv6.1.9で更新します。

## 参照

- `EDITION_POLICY.md` — Edition管理原則
- `RELEASE-NOTES-v6.1.9.md` — v6.1.9の変更内容
