...
> Current release: SIMS Manager Product v6.1.15
...
- 利用者向けDistribution ZIPは必要になった時だけ生成します。v6.1.15はRepository Baselineであり、配布版リリースではありません。
