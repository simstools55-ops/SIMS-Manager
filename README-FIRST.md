# SIMS Manager v6.1.4 Repository Baseline
...
Starterの実行用 `Code.gs` は、Starter機能境界を確定・検証した後にFull正本から生成します。未検証のStarterコードは正本に含めません。

## GitHubへの反映

このZIP内の `SIMS-Manager/` を既存SIMS Managerリポジトリへ反映してください。既存の履歴ファイルは保持し、同名の現行正本ファイルはv6.1.4で更新します。

## 参照

- `EDITION_POLICY.md` — Edition管理原則
- `RELEASE-NOTES-v6.1.1.md` — v6.1.1の変更内容
