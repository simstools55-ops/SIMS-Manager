...
> Current release: SIMS Manager Product v6.1.19
...
- 利用者向けDistribution ZIPは必要になった時だけ生成します。v6.1.19はRepository Baselineであり、配布版リリースではありません。Starterの利用者向け表示は v6.1.19-Starter です。
