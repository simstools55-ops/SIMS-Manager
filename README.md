...
> Current release: SIMS Manager Product v6.1.13
...
- 利用者向けDistribution ZIPは必要になった時だけ生成します。v6.1.13はRepository Baselineであり、配布版リリースではありません。
