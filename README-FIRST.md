# SIMS Manager v6.1.10 Repository Baseline
...
このZIP内の `SIMS-Manager/` を既存SIMS Managerリポジトリへ反映してください。既存の履歴ファイルは保持し、同名の現行正本ファイルはv6.1.10で更新します。

## 参照

- `EDITION_POLICY.md` — Edition管理原則
- `RELEASE-NOTES-v6.1.10.md` — v6.1.10の変更内容
