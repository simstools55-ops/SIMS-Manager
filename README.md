...
> Current release: SIMS Manager Product v6.1.26
...
- 利用者向けDistribution ZIPは必要になった時だけ生成します。v6.1.26はRepository Baselineであり、配布版リリースではありません。Starterの利用者向け表示は v6.1.26-ST です。
