...
> **Current product:** SIMS Manager v6.1.10  
...
> Current release: SIMS Manager Product v6.1.10
...
- 利用者向けDistribution ZIPは必要になった時だけ生成します。v6.1.10はRepository Baselineであり、配布版リリースではありません。
