...
> Current release: SIMS Manager Product v6.2.42

## v6.2.42 — 記事情報更新を不足記事限定方式へ再構築
...
- 利用者向けDistribution ZIPは必要になった時だけ生成します。v6.2.42はRepository Baselineであり、配布版リリースではありません。Starterの利用者向け表示は v6.2.42-ST です。
