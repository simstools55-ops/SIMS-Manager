...
> **Current product:** SIMS Manager v6.1.5  
...
> Current release: SIMS Manager Product v6.1.5
...
- 利用者向けDistribution ZIPは必要になった時だけ生成します。v6.1.5はRepository Baselineであり、配布版リリースではありません。
